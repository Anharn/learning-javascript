...
function reset() {
    ...
    const startingWeapon = new Item(context.map.pickRandomWeapon());
    const startingItem = new Item(context.map.pickRandom());
    const startingSpell = new Spell(context.map.pickRandom(spellTemplates));
